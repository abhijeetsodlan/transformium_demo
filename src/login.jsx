...
import terrylogin from './assets/terrylogin.jpg'; // Importing the image

function LoginPage() {
  return (
    <div className="relative min-h-screen">
      {/* Image container with blurry overlay */}
      <div
        className="absolute inset-0 bg-cover bg-center"
        style={{
          backgroundImage: `url(${terrylogin})`, // Using the imported image
        }}
      ></div>
      <div className="absolute inset-0 bg-black bg-opacity-40 backdrop-blur-sm"></div> {/* Blurry overlay */}
